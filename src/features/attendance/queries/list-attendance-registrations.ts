...
export type AttendanceFilters={firstName?:string;lastName?:string;school?:string;phone?:string;attendance?:string;attendedByUserId?:string;attendedFrom?:string;attendedTo?:string;page?:number;pageSize?:number;sort?:string};
