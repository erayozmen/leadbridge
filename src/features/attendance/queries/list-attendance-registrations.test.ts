...
it("calculates pagination",async()=>{const d=deps();await listAttendanceRegistrations({page:3},d);expect(d.findMany).toHaveBeenCalledWith(expect.objectContaining({skip:40,take:ATTENDANCE_PAGE_SIZE}));});
