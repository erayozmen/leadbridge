...
describe("listQrRegistrations",()=>{
  ...
  it("calculates pagination",async()=>{const d=deps();await listQrRegistrations({page:3},{},d);expect(d.findMany).toHaveBeenCalledWith(expect.objectContaining({skip:40,take:REGISTRATIONS_PAGE_SIZE}));});
