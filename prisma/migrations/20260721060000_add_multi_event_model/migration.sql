...
-- Add nullable columns before deterministic legacy backfill
...
-- Preserve all existing records under one explicit legacy event
INSERT INTO "Event" ("id", "name", "eventDate", "location", "status", "createdAt", "updatedAt")
VALUES ('leadbridge-legacy-event', 'LeadBridge Legacy Etkinliği', CURRENT_TIMESTAMP, 'Belirtilmedi', 'COMPLETED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
